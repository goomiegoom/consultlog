// Consultant view — assigned projects, can log meetings on any of them
...
function ConsultantView({
  ...
  // My recent logs across all projects
  const myLogs = logs.filter((l) => l.consultantId === currentConsultantId)
          ...
          return (
            <Card>
              <CardHeader
                ...
                action={<Button size="sm" variant="primary" icon={<IconPlus size={13} />} onClick={() => setLogFor(proj)}>Log meeting</Button>} />
...
Object.assign(window, { ConsultantView });
